...
for filename in os.listdir(".") :
    ...
    trimmo.write("java -jar /storage/home/users/pjt6/fly_selective_sweeps/Trimmomatic-0.39/trimmomatic-0.39.jar PE -threads 4 -phred33 %s_1.fq.gz %s_2.fq.gz ../trimmed/%s_R1_paired.fq.gz ../trimmed/%s_R1_unpaired.fq.gz ../trimmed/%s_R2_paired.fq.gz ../trimmed/%s_R2_unpaired.fq.gz ILLUMINACLIP:/storage/home/users/pjt6/fly_selective_sweeps/Trimmomatic-0.39/adapters/TruSeq3-PE.fa:2:30:10 LEADING:3 TRAILING:3 SLIDINGWINDOW:4:25 MINLEN:69\n" \
    ...
    print("java -jar /storage/home/users/pjt6/fly_selective_sweeps/Trimmomatic-0.39/trimmomatic-0.39.jar PE -threads 4 -phred33 %s_1.fq.gz %s_2.fq.gz ../trimmed/%s_R1_paired.fq.gz ../trimmed/%s_R1_unpaired.fq.gz ../trimmed/%s_R2_paired.fq.gz ../trimmed/%s_R2_unpaired.fq.gz ILLUMINACLIP:/storage/home/users/pjt6/fly_selective_sweeps/Trimmomatic-0.39/adapters/TruSeq3-PE.fa:2:30:10 LEADING:3 TRAILING:3 SLIDINGWINDOW:4:25 MINLEN:69\n" \
                 % (prefix, prefix, exp, exp, exp, exp))
    trimmo.close()
    print("qsub -V -pe multi 4 trimmo_%d.sh\n" % count)
fastqc_script.close()
handle.close()
